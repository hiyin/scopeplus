...
balf = Blueprint('balf', __name__, url_prefix='/balf')
...
@balf.route('/show_plot', methods=['GET', 'POST'])
def show_plot():     
...
def balf_tableview():
    ...
    return render_template('tasks/balf_tableview.html',
                           fdonor=fdonor,
                           fage=fage,
                           fsampleid=fsampleid,
...
# Download big file
@balf.route('/download_meta', methods=['POST'])
def download_meta():
...
@balf.route('/download_umap', methods=['POST'])
def download_umap():
...
@balf.route('/download_matrix', methods=['POST'])
def download_matrix():
...
@balf.route('/api_db', methods=['GET', 'POST'])
@login_required
def api_db():
    data = []
